...
<template>
  <div class="w-full">
    <div class="flex justify-around">
      <div class="w-1/2">
        <img src="../../asset/auth-img2.png" alt="Connexion" />
      </div>
      <div class="w-1/2 bg-[var(--color-background)]">
        <div>
          <img class="w-[200px] h-[150px]" src="../../asset/LogoYunoaeducation.png" alt="" />
        </div>
        <div>
          ...
          <div>
            <form action="">
              ...
              <div>
                <h2 class="mb-2 mt-8 font-semibold">E-mail</h2>
                <div class="p-2 border-neutral-300 rounded-[8px] flex border items-center gap-2.5">
              ...
              <div class="mt-1">
                <h2 class="mb-2 font-semibold">Mot de passe actuel</h2>
            ...
            <div class="text-center mb-12">
              ...
              <a href="" class="text-[var(--color-linkbtn)] font-semibold">Se connecter</a>
            </div>
          </div>
